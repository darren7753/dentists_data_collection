...
url = "https://yankes.kemkes.go.id/klinik/cari?propinsi=&kabkota=&jenis=&nama=dental"
driver.get(url)
...
def scrape_data():
    ...
    address = address_elements[2].text
    phone = address_elements[3].text
...
df.to_excel("Data/data_third_link.xlsx", index=False)